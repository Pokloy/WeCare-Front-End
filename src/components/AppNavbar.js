            ...
            <Navbar expand="lg" expanded={expanded}>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                        <Nav.Link as={NavLink} to="/about" className="px-3" onClick={() => setExpanded(false)}>
                            <h5 className="font-white">About Us</h5>
                        </Nav.Link>
                        <Nav.Link as={NavLink} to="/find-care" className="px-3" onClick={() => setExpanded(false)}>
                            <h5 className="font-white">Find Care</h5>
                        </Nav.Link>
                        <Nav.Link as={NavLink} to="/services" className="px-3" onClick={() => setExpanded(false)}>
                            <h5 className="font-white">Services</h5>
                        </Nav.Link>
                        <Nav.Link as={NavLink} to="/sign-in" className="px-3" onClick={() => setExpanded(false)}>
